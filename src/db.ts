/**
 * SQLite database access layer for the KNF MCP server.
 *
 * Schema mirrors the KNF regulatory structure:
 *   - sourcebooks        — top-level KNF document categories (Rekomendacje, Wytyczne, Stanowiska)
 *   - provisions         — individual provisions from KNF documents
 *   - enforcement_actions — KNF enforcement decisions and penalties
 *
